                      ...
                      >
                        <div className="space-y-3">
                          ...
                          <p className="text-sm leading-relaxed text-white/80">
                            {course.slug === "iplace-irestore"
                              ? "This intensive course covers comprehensive training in single and multiple implant placement and restoration techniques. Learn advanced protocols, surgical procedures, and prosthetic solutions from industry-leading experts."
                              : "Master the All-on-X protocol with this comprehensive intensive course. Learn full arch rehabilitation techniques, immediate loading protocols, and advanced prosthetic workflows for complete oral reconstruction."}
                          </p>
                        </div>
