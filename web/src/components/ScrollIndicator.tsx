...
export default function ScrollIndicator() {
  ...
  return (
    <div
      ref={containerRef}
      className="fixed top-16 right-4 z-20 flex flex-col items-center gap-2 rounded-lg border border-white/10 bg-black/20 px-3 py-2 backdrop-blur-sm md:top-20 md:right-6"
